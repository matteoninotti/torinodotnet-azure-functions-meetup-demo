...
- **Registrare nel log ogni decisione bloccata.** Va aggiunta a `dotnet_lambda-log.md` §2 sotto un heading `### YYYY-MM-DD` con la **data corrente** (un heading nuovo per giorno; la numerazione `D#` è **continua** tra le date — dopo `D13` viene `D14`). **L'heading è solo la data, senza sottotitolo**: `### 2026-09-10`, non `### 2026-09-10 — onboarding di Fase 3`. Mai riscrivere le voci passate.
